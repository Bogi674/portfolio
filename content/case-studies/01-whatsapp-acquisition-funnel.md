...
Every customer reply to a WhatsApp promotion went through the same manual path: staff recapped the reply, fed it into the telemarketing system, and queued a follow-up for the next day. Customers who had just expressed interest waited 12 to 24 hours to hear back.

Even with that delay, the channel outperformed. WhatsApp promotions converted 30 to 40 percent better than pure cold calling. That gap was the signal: the channel had real pull. The process was the bottleneck.
...
Conversion jumped to roughly 80 percent above non-WhatsApp channels. Cutting the process cycle from 24 hours to under one hour was enough to move that result, with no structural change to the flow at all. Reply speed mattered far more than we had assumed.

![Iteration 1: same manual process, run hourly instead of daily, conversion up 80 percent vs non-WhatsApp channels](images/case-study-01/iter-1-hourly.svg)

### Iteration 2: Live Agent in the Chat

If hourly was that much better than daily, near-instant should be better still. We removed the recap-and-queue pipeline entirely and put live agents directly into the conversation.

Conversion stepped up again, reaching nearly double the non-WhatsApp baseline. Two experiments, one consistent pattern: the faster the reply, the better the conversion. Reply speed was the single biggest lever in the funnel.
